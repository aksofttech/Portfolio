...
export default function Projects() {
  ...
  return (
    <div style={{ minHeight: '100vh', padding: '6rem 2rem', maxWidth: '1200px', margin: '0 auto' }}>
        <div style={{ textAlign: 'center', marginBottom: '5rem' }}>
            ...
            <h1 style={{ fontSize: '3.5rem', marginTop: '1.5rem', marginBottom: '1rem', color: 'var(--text-primary)' }}>Featured Projects</h1>
