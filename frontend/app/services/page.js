  ...
  return (
    <div style={{ minHeight: '100vh', paddingBottom: '8rem' }}>
        ...
        <div style={{ textAlign: 'center', paddingTop: '6rem', paddingBottom: '2rem' }}>
            ...
            <h1 style={{ fontSize: '4rem', marginTop: '1.5rem', marginBottom: '1rem', color: 'var(--text-primary)' }}>Comprehensive Software Solutions</h1>
        ...
        <section className="how-it-works" id="services" style={{ marginTop: '2rem' }}>
            <div className="how-container" style={{ maxWidth: '1400px' }}>
                <div className="how-cards" style={{ gap: '4rem' }}>
                    
                    {/* Service 1 */}
                    <div className="how-card">
                        <div className="how-3d" id="how-3d-1"></div>
                    ...
                    {/* Service 2 */}
                    <div className="how-card">
                        <div className="how-3d" id="how-3d-2"></div>
                    ...
                    {/* Service 3 */}
                    <div className="how-card">
                        <div className="how-3d" id="how-3d-3"></div>
