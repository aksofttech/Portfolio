  ...
  return (
    <div style={{ minHeight: '100vh', paddingBottom: '8rem' }}>
        ...
        <div style={{ textAlign: 'center', paddingTop: '6rem', paddingBottom: '4rem' }}>
            ...
            <h1 style={{ fontSize: '4rem', marginTop: '1.5rem', marginBottom: '1rem', color: 'var(--text-primary)' }}>Flexible Engagement Models</h1>
        ...
        <section style={{ padding: '6rem 2rem', background: 'var(--bg-secondary)', borderTop: '1px solid var(--border-color)', marginTop: '4rem' }}>
            <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
                <div style={{ textAlign: 'center', marginBottom: '4rem' }}>
                    <h2 style={{ fontSize: '3.5rem', marginBottom: '1rem', color: '#fff' }}>The AK SOFT-TECH Advantage</h2>
